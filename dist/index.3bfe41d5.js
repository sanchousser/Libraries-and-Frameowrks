...
var _task1 = require("./js/task-1");
var _task2 = require("./js/task-2");

},{"./js/task-1":"9zt7I","./js/task-2":"jYNJC"}],"9zt7I":[function(require,module,exports) {
...
function checkPresedKey(e) {
    if (e.key === keys[currentKeyIndex]) {
        ...
        currentKeyIndex++;
        if (currentKeyIndex <= keys.length) key.textContent = keys[currentKeyIndex];
        else (0, _core.alert)({
            text: "You won!",
            delay: 2000
        });
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}],"jYNJC":[function(require,module,exports) {
...
const salesChart = new (0, _chartJs.Chart)(element, {
    type: "line",
    data: chartData,
    options: {
        responsive: true,
